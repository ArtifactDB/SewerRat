...
func TestSanitizeQueryAndOr(t *testing.T) {
    ...
    query.Children = []*searchClause{ nil, nil }
    {
        san, err := sanitizeQuery(query, deftok, wildtok)
        if err != nil {
            t.Fatalf(err.Error())
    ...
    query.Children = []*searchClause{ &searchClause{ Type: "text", Text: "Aaron" } }
    {
        san, err := sanitizeQuery(query, deftok, wildtok)
        if err != nil {
            t.Fatalf(err.Error())
    ...
    query.Children = []*searchClause{ &searchClause{ Type: "text", Text: "Aaron" }, &searchClause{ Type: "text", Text: "Lun" } }
    {
        san, err := sanitizeQuery(query, deftok, wildtok)
        if err != nil {
            t.Fatalf(err.Error())
    ...
    query.Children = []*searchClause{ &searchClause{ Type: "text", Text: "Aaron Lun" }, &searchClause{ Type: "text", Text: "Jayaram Kancherla" } }
    {
        san, err := sanitizeQuery(query, deftok, wildtok)
        if err != nil {
            t.Fatalf(err.Error())
...
func TestSanitizeQueryText(t *testing.T) {
    deftok, _ := newUnicodeTokenizer(false)
    wildtok, _ := newUnicodeTokenizer(true)
...
func TestSanitizeQueryOther(t *testing.T) {
    deftok, _ := newUnicodeTokenizer(false)
    wildtok, _ := newUnicodeTokenizer(true)
